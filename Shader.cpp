...
// It is not related to OpenGL & GLFW rendering so it will not be focused upon
// Makes it possible for us to write shaders using a text editor rather than storing it as a string
